package pdf_epub_provider.utils;
...
import static pdf_epub_provider.utils.HtmlUtil.updateHtml;
import static pdf_epub_provider.utils.TxtUtil.updateTxt;
...
public class EpubUtil {
    ...
    public static void toEpub(String filePath, String targetFile) {
        try {
            String[] bookTitle = pdf_epub_provider.utils.PdfUtil.getBookTitle();
            int[] pageNumber = pdf_epub_provider.utils.PdfUtil.getPageNumber();
            int strindex = pdf_epub_provider.utils.PdfUtil.getStrindex();
